class FundProcessor {
  ...
  get bet() {
    ...
    if (base < 100) {      //99
      ...
      return {bet: 5, grit: 10}
    }
    else if (base < 1600) {  //200
      return {bet: 8, grit: 20}
    }
    else if (base < 2500) {  //250
      return {bet: 10, grit: 50}
    }
    else if (base < 6000) {  //300
      return {bet: 20, grit: 100}
    }
    else if (base < 17500) { //350
      return {bet: 50, grit: 200}
    }
    else if (base < 40000) {  //400
      return {bet: 100, grit: 300}
    }
    else if (base < 90000) {  //450
      return {bet: 200, grit: 400}
    }
    else if (base < 150000) {  //500
      return {bet: 300, grit: 500}
    }
    else if (base < 220000) {  //550
      return {bet: 400, grit: 700}
    }
    else if (base < 300000) {  //600
      return {bet: 500, grit: 1000}
    }
    else if (base < 455000) {  //650
      return {bet: 700, grit: 1000}
    }
    else {
      return {bet: 1000, grit: 1000}
    }
  }
